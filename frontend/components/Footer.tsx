...
export default function Footer() {
  return (
    ...
    >
        ...
        <div className="flex flex-col items-center md:items-end gap-3">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium transition-colors duration-200 hover:text-white cursor-pointer"
              style={{
      ...
      {/* Bottom Copyright */}
      <div
        className="max-w-7xl mx-auto px-6 mt-6 pt-6 flex items-center justify-between text-xs"
